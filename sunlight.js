...
module.exports.fetchActiveBills = function(params, cb) {
  superagent.get("https://congress.api.sunlightfoundation.com/bills?history.active=true&order=last_action_at&per_page=50"
...
module.exports.fetchLegislatorVotes = function(params, cb) {
  superagent.get("https://congress.api.sunlightfoundation.com//votes?voter_ids." + params.bioguide +
...
module.exports.fetchLegislators = function(params, cb) {
  superagent.get("https://congress.api.sunlightfoundation.com/legislators" + params.method + params.zip +"&per_page=all")
    .set('X-APIKey', params.api_key)
    .set({  Accept: 'application/json' })
    .end(function(e, sunlightResponse){
      if (e){
